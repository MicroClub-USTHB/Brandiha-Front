...
Opened from the review of PR #42 (`feat/refresh-token-integration`), 2026-07-27.

| # | Item | Where | Blocking? |
|---|------|-------|-----------|
| [01](./01-login-bounce-on-backend-outage.md) | Backend outage bounces a valid session to a bare login form | frontend | no |
| [02](./02-apifetch-midflight-401.md) | `apiFetch` cannot recover from a mid-flight token expiry | frontend | no |
