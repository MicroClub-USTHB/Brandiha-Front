...
export const BRANDIHA_AGENDA_DATA: AgendaCardData[] = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "11h → 12h30", title: "challenge 1 (multi)" },
      { time: "13h → 14h", title: "prayer" },
      { time: "14h → 15h", title: "Lunch" },
      { time: "15h → 17h", title: "Workshop/talk" },
      { time: "17h → 18h", title: "Activities" },
      { time: "18h → 21h", title: "Work" },
      { time: "21h → 22h", title: "Dinner" },
      { time: "22h → 00h", title: "Work" },
    ],
  },
  {
    dayNumber: "DAY3",
    ...
    schedule: [
      { time: "00h → 1h30", title: "challenge 2 (design)" },
      { time: "2h → 3h30", title: "Coffee break" },
      { time: "3h30 → 8h", title: "Work" },
      { time: "8h → 9h", title: "Breakfast" },
      { time: "9h → 13h", title: "Work" },
      { time: "13h → 14h", title: "Lunch" },
      { time: "14h → 15h30", title: "challenge 3 (la comm)" },
  ...
  },
  {
    ...
    schedule: [
      { time: "00h → 1h30", title: "challenge 4 (marketing)" },
      ...
      { time: "13h → 14h", title: "Lunch" },
      { time: "14h → 17h", title: "Teasers projection" },
      {
        time: "17h → 17h30",
